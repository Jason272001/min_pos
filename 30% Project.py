...
def view_edit():
    choice = input("Enter choice: view_cart = 1 or edit_cart = 2:")
    if choice == "1":
        print(cart)
    else:
        selection = input("What do you want to do: edit_item = 1 or add_item = 2 :")
        while selection == "1":
            option = input("enter which item do you want to edit from cart?")
            if option in cart:
                del_quality = int(input("How many quality do you want to edit from cart:"))
                if (del_quality==0):
                  
                  del cart[option] 
                  print(cart)
                else:    
                  cart.update({option: del_quality})
                
                
                print(cart)
                break
            else:
                print("Invalid input. Please enter a valid item in your cart")
                continue
...
def payment():
    ...
    price = {"Milk": 2.461, "Butter": 4.815, "Eggs": 3.638, "Cheese Slices": 3.3705,
                 "Evaporated Milk Creamer": 1.498, "Milo": 13.375, "Biscuits": 5.671, "Yogurt": 1.0165,"Tomato": 1.5515, "Button Mushroom": 1.2305, "Baking Bean": 1.4445, "Tuna Fish": 1.5515,
                  "Kernel Corn": 1.3375, "Sardine Fish": 1.177, "Chicken Luncheon Meat": 2.0865,
                  "Pickled Lettuce": 1.0165,"Green Tea Canned 300 Ml": 16.05, "Blackcurrant Ribena 300 Ml": 33.17, "100 Plus 24 Cans": 16.05,
              "Orange Cordial 2 Litre": 4.173, "Mineral Water 24 X 600 Ml": 7.49, "Pineapple Juice": 0.856,
              "Nescafe Coffee": 10.593, "Coke 24 Cans": 13.268,"Fine Salt": 0.856, "Sea Salt Flakes": 1.391, "Chicken Stock": 3.3705, "Chilli Sauce":2.8355,
              "Oyster Sauce": 4.815, "Sweet Soy Sauce": 4.0125, "Tomato Ketchup": 3.424, "Sesame Oil": 5.2965,"Bread": 2.889, "Cereal": 7.49, "Crackers": 3.317, "Chips": 2.782, "Raisin": 2.247, "Nuts": 2.14,"Green Bean": 1.1235, "Barley": 1.1235}

    for k,v in cart.items():
         
    
     
     for k in range(cart[k]):
             ...
             if option=="1":
               print ("[1] Kbz Pay Payment")   
               print ("[2] VISA Payment") 
                                        
               poption=input("Enter Number:")
               if poption=="1":
                     print("Send money to '0994546485'")
                     print("Thank you")
               elif poption=="2":
                    idc=int(input("Enter Your Card number:"))   
